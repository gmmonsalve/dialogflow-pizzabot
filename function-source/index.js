...
const datastore = new Datastore({
  projectId: 'qwiklabs-gcp-02-0890e0a8d2d8'
});
...
exports.dialogflowFirebaseFulfillment = functions.https.onRequest((request, response) => {
  ...
  function order_drink(agent){
    var drink_composite = agent.parameters.drink_composite;
    var drink = agent.parameters.drink;
    var size = agent.parameters.size;
    var percentage = agent.parameters.percentage;
    const taskKey = datastore.key('order_item');
      const entity = {
        ...
        item_name: 'drink',
        drink: drink,
        drink_composite: drink_composite,
        size: size,
    ...
    return datastore.save(entity).then(() => {
                ...
                agent.add(`Ok! the drink is now added to your order`);
